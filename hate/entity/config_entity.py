...
class ModelTrainConfig:
    def __init__(self):
        ...
        self.MODEL_TRAIN_PATH =  os.path.join(os.getcwd(),ARTIFACTS_DIR,MODEL_TRAIN_ARTIFACTS_DIR)
        self.MODEL_TRAIN_ARTIFACTS_PATH = os.path.join(self.MODEL_TRAIN_PATH,TRAINED_MODEL_NAME)
        ...
        self.X_TRAIN_FILE_PATH = os.path.join(self.MODEL_TRAIN_PATH,X_TRAIN_FILE_NAME)
        self.X_TEST_FILE_PATH = os.path.join(self.MODEL_TRAIN_PATH,X_TEST_FILE_NAME)
        self.VALIDATION_SPLIT = VALIDATION_SPLIT
        self.Y_TEST_FILE_PATH = os.path.join(self.MODEL_TRAIN_PATH,Y_TEST_FILE_NAME)
